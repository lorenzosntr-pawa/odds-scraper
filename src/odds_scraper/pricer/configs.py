...
TUNABLE_NAMES = (
    ...
    "NEAR_EVEN_THRESHOLD",
    # V3-only odds-space cap reductions (% off the 1X2 ceiling), per market per side.
    "ONEUP_FAVORITE_REDUCTION_PCT",
    "ONEUP_UNDERDOG_REDUCTION_PCT",
    "TWOUP_FAVORITE_REDUCTION_PCT",
...
DEFAULT_COEFFICIENTS = {
    ...
    # V3 odds-space cap reductions (% off the 1X2 ceiling), per market per side.
